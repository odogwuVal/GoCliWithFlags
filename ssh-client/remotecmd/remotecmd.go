...
// This function provides a secure way to read a password from the terminal for SSH authentication purposes. It prompts the user,
// hides the password input, handles potential errors, and ensures an empty password isn't accidentally used.
...
// This function provides a way to load a private key file and create the corresponding public key authentication method for SSH.
// It handles potential errors during file reading and key parsing.
